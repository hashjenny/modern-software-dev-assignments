...
week2/app/routers/notes.py: L3-L45（引入 Pydantic 请求/响应模型，收紧 API 合约；补充数据库异常 -> 500 的一致错误处理）
week2/app/routers/action_items.py: L3-L80（引入 Pydantic 请求/响应模型，收紧 API 合约；补充数据库异常 -> 500 的一致错误处理）
