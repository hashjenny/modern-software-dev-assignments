...
def test_update_note_not_found(client):
    r = client.put("/notes/99999", json={"title": "Updated", "content": "Updated content"})
...
def test_create_note_validation_empty(client):
    r = client.post("/notes/", json={"title": "", "content": "x"})
    assert r.status_code == 422, r.text


def test_create_note_validation_missing(client):
